...
struct WeatherNeedHardeningTests {
    ...
    private func context(
        ...
        return TripContext(
            ...
            durationDays: math.days, durationNights: math.nights, tripTypes: [type],
            activities: activities, datedActivities: [], bagTypes: Set([bag].filter(BagType.stableOrder.contains)),
