...
/// Frozen snapshot of the 4.1.0 store shape — V4 plus `preferredBagTypesMigrated`,
/// the shape `main` persisted from c5c35bb until the Product Hardening Phase 8 merge
/// (those builds labeled it 4.0.0; stores match by hash, not label).
/// Captured from `d7663a5`; real store checksum `KvqcAwSlpmBjwezusGlTtsjpmlur9gXai2JL9k8VTms=`.
/// Generated from that commit's `@Model` declarations: stored properties,
/// attributes, relationships, and declared defaults only. Do not edit —
/// `StoreHistoryTests` pins these entity hashes to real captured stores.
...
/// Frozen snapshot of the 5.0.0 store shape — V4.1 plus Product Hardening
/// Phase 8's four persisted trace-fact columns on `PackingItemRecord`
/// (`quantityEvidenceRaw`, `quantityReasonArgumentsRaw`,
/// `satisfiedCapabilitiesRaw`, `bagStyleConstraintFactRaw`), the shape
/// `product-v2-stage-a` persisted from the Phase 8 merge through `b4a7260`
/// (Task 9.1). Captured from `b4a7260`; `StoreFixtures/v5-b4a7260` is a real
/// store that build wrote. Generated from that commit's `@Model`
/// declarations: stored properties, attributes, relationships, and declared
/// defaults only. Do not edit — `StoreHistoryTests` pins these entity hashes
/// to real captured stores.
